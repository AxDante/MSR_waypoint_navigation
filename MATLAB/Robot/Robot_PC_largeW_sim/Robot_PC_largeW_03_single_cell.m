...
if ( strcmp( Algorithm, 'square_waypoint'))
    ...
    for step = 1:max_step
        ...
        if (is_coverage_map == 1)
            if (is_single_cell)
                 Line_Robot(2,1) = line([pos_center(2, 1, step)+grid_dhw*cos(pi/4 - heading(2)) ...
                                                         pos_center(2, 1, step)+grid_dhw*sin(pi/4 - heading(2))], ...
                                                        [pos_center(2, 2, step)+grid_dhw*sin(pi/4 -  heading(2)) ...
                                                         pos_center(2, 2, step)+grid_dhw*-cos(pi/4 -  heading(2))], 'Color', 'yellow', 'LineWidth', 2);
                Line_Robot(2,2) = line([pos_center(2, 1, step)+grid_dhw*cos(pi/4 -  heading(2))... 
                                                         pos_center(2, 1, step)+grid_dhw*-sin(pi/4 -  heading(2))], ...
                                                        [ pos_center(2, 2, step)+grid_dhw*sin(pi/4 -  heading(2))...
                                                          pos_center(2, 2, step)+grid_dhw*cos(pi/4 -  heading(2))], 'Color', 'yellow', 'LineWidth', 2);
                Line_Robot(2,3) = line([pos_center(2, 1, step)+grid_dhw*-cos(pi/4 -  heading(2)) ...
                                                         pos_center(2, 1, step)+grid_dhw*-sin(pi/4 -  heading(2))], ...
                                                        [ pos_center(2, 2, step)+grid_dhw*-sin(pi/4 -  heading(2)) ...
                                                          pos_center(2, 2, step)+grid_dhw*cos(pi/4 -  heading(2))], 'Color', 'yellow', 'LineWidth', 2);
                Line_Robot(2,4) = line([pos_center(2, 1, step)+grid_dhw*-cos(pi/4 -  heading(2)) ...
                                                         pos_center(2, 1, step)+grid_dhw*sin(pi/4 -  heading(2))], ...
                                                        [ pos_center(2, 2, step)+grid_dhw*-sin(pi/4 -  heading(2))...
                                                          pos_center(2, 2, step)+grid_dhw*-cos(pi/4 -  heading(2))], 'Color', 'yellow', 'LineWidth', 2);
            else
        ...
        if (is_single_cell)
            Line_Robot(2,1) = line([pos_center(2, 1, step)+grid_dhw*cos(pi/4 - heading(2)) ...
                                                     pos_center(2, 1, step)+grid_dhw*sin(pi/4 - heading(2))], ...
                                                    [pos_center(2, 2, step)+grid_dhw*sin(pi/4 -  heading(2)) ...
                                                     pos_center(2, 2, step)+grid_dhw*-cos(pi/4 -  heading(2))], 'Color', 'green', 'LineWidth', 1);
            Line_Robot(2,2) = line([pos_center(2, 1, step)+grid_dhw*cos(pi/4 -  heading(2))... 
                                                     pos_center(2, 1, step)+grid_dhw*-sin(pi/4 -  heading(2))], ...
                                                    [ pos_center(2, 2, step)+grid_dhw*sin(pi/4 -  heading(2))...
                                                      pos_center(2, 2, step)+grid_dhw*cos(pi/4 -  heading(2))], 'Color', 'green', 'LineWidth', 1);
        ...
        if(is_calculate_coverage)
            for cvg_idx = 1: numel(Cvg(:, 1))
                if (is_single_cell)
                     if (Cvg(cvg_idx, 3) == 0)
                            tri1_x = [pos_center(2, 1, step)+grid_dhw*cos(pi/4 - heading(2)) ...
                                          pos_center(2, 1, step)+grid_dhw*sin(pi/4 - heading(2)) ...
                                          Cvg(cvg_idx, 1)];
                            tri1_y = [pos_center(2, 2, step)+grid_dhw*sin(pi/4 -  heading(2))  ...
                                          pos_center(2, 2, step)+grid_dhw*-cos(pi/4 -  heading(2)) ...
                                          Cvg(cvg_idx, 2)];
                            area1 = polyarea(tri1_x,tri1_y);
                            tri2_x = [pos_center(2, 1, step)+grid_dhw*cos(pi/4 -  heading(2)) ...
                                          pos_center(2, 1, step)+grid_dhw*-sin(pi/4 -  heading(2)) ...
                                          Cvg(cvg_idx, 1)];
                            tri2_y = [pos_center(2, 2, step)+grid_dhw*sin(pi/4 -  heading(2))  ...
                                          pos_center(2, 2, step)+grid_dhw*cos(pi/4 -  heading(2)) ...
                                          Cvg(cvg_idx, 2)];
                            area2 = polyarea(tri1_x,tri1_y);
                            tri3_x = [pos_center(2, 1, step)+grid_dhw*-cos(pi/4 -  heading(2)) ...
                                          pos_center(2, 1, step)+grid_dhw*-sin(pi/4 - heading(2)) ...
                                          Cvg(cvg_idx, 1)];
                            tri3_y = [pos_center(2, 2, step)+grid_dhw*-sin(pi/4 -  heading(2))  ...
                                          pos_center(2, 2, step)+grid_dhw*cos(pi/4 -  heading(2)) ...
                                          Cvg(cvg_idx, 2)];
                            area3 = polyarea(tri3_x,tri3_y);
                            tri4_x = [pos_center(2, 1, step)+grid_dhw*-cos(pi/4 -  heading(2)) ...
                                          pos_center(2, 1, step)+grid_dhw*sin(pi/4 -  heading(2)) ...
                                          Cvg(cvg_idx, 1)];
                            tri4_y = [pos_center(2, 2, step)+grid_dhw*-sin(pi/4 -  heading(2)) ...
                                          pos_center(2, 2, step)+grid_dhw*-cos(pi/4 -  heading(2)) ...
                                          Cvg(cvg_idx, 2)];
