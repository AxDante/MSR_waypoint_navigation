...
elseif (strcmp(navigation_mode,'Point04'))
    ...
    for idx = 1: grid_size(1)-2
            if (idx == 1)
                ...
                Wp = [Wp; 5.5*grid_w  5.5*grid_w 2 0];
                Wp = [Wp; 6.5*grid_w  5.5*grid_w 2 0];
                Wp = [Wp; 7.5*grid_w  5.5*grid_w 2 0];
            ...
            elseif (idx == 2)
                ...
                Wp = [Wp; 8.5*grid_w  6.5*grid_w 1 0];
                Wp = [Wp; 8.5*grid_w  7.5*grid_w 1 0];
            elseif (idx == 3)
                Wp = [Wp; 8.5*grid_w  7.5*grid_w 1 0];
                Wp = [Wp; 7.5*grid_w  7.5*grid_w 1 0];
                Wp = [Wp; 6.5*grid_w  7.5*grid_w 1 0];
            ...
            elseif (idx == 5)
                ...
                Wp = [Wp; 3.5*grid_w  8.5*grid_w 3 0];
                Wp = [Wp; 2.5*grid_w  8.5*grid_w 3 0];
                Wp = [Wp; 1.5*grid_w  8.5*grid_w 3 0];
                Wp = [Wp; 0.5*grid_w  8.5*grid_w 3 0];
                Wp = [Wp; 0.5*grid_w  8.5*grid_w 1 0];
                Wp = [Wp; 0.5*grid_w  7.5*grid_w 1 0];
                Wp = [Wp; 0.5*grid_w  6.5*grid_w 1 0];
