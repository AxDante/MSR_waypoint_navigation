    ...
    for idxrow = 1:floor(grid_size(2)/2)
        ...
        while (~end_of_row && while_exit_counter < 25)
            ...
            if (robot_shape == 2 && dir == 1)
                ...
                if (checkNextCase && rcg(1)+2 == grid_size(1) && rcg(1)-1 > 0)
                    if (Grid_obstacle(rcg(1)+2, rcg(2)) == 0 &&...
                        Grid_obstacle(rcg(1)+2, rcg(2)-1) == 0)
                        Wp = [Wp; rcg(1)+1 rcg(2) 2];
                        if(Grid_obstacle(rcg(1)+1,    rcg(2)+1) == 0 && ...
                           Grid_obstacle(rcg(1)+2, rcg(2)+1) == 0)
                            Wp = [Wp; rcg(1)+1 rcg(2)+1 2];
                            if(Grid_obstacle(rcg(1)+1, rcg(2)+3) == 0 && ...
                               Grid_obstacle(rcg(1)+2, rcg(2)+3) == 0)
                               Wp = [Wp; rcg(1)+1 rcg(2)+2 2];
                               dir = -1;
                            end
                        end
                        checkNextCase = false;
                ...
                if (checkNextCase && rcg(1)+3 <= grid_size(1) && rcg(1)-1 > 0)
                    if (Grid_obstacle(rcg(1)+3, rcg(2)) == 1 &&...
                        Grid_obstacle(rcg(1)+3, rcg(2)-1) == 0 && ...
                        Grid_obstacle(rcg(1)-1, rcg(2)) == 0 && ...
