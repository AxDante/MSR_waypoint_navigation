...
function gsc = PCA_get_grid_shape_change(rowidx,colidx, gs, Gobs)
    ...
    Rgp = [0 -1; 0 1; 0 2;                         % Relative grid positions between modules
     ...
     Scp{2, 1} = [0 0; 0 1; 0 2; 0 -1; 1 -1; 1 0; 1 1; 1 2; 2 0; 2 1];
     Scp{1, 2} = [0 0; 0 1; 0 2; 0 -1; 1 -1; 1 0; 1 1; 1 2; 2 0; 2 1];
     Scp{2, 8} = [-1 -1; -1 0; 0 -1; 0 0; 1 -1; 1 0; 2 -1; 2 0];
     Scp{8, 2} = [-1 -1; -1 0; 0 -1; 0 0; 1 -1; 1 0; 2 -1; 2 0];
     Scp{1, 8} = [0 0; 0 1; 0 2; 0 -1; 1 -1; 1 0; 1 1; 1 2; 2 0; 2 1; -1 0; -1 -1];
     Scp{8, 1} = [0 0; 0 1; 0 2; 0 -1; 1 -1; 1 0; 1 1; 1 2; 2 0; 2 1; -1 0; -1 -1];
