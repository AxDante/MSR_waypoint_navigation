function [Wp_s, Gvis_best] = PC_NewAlg(gs, Gobs, Wp, Gvis, scg, gcg, GA, rows, cols)
    ...
    while (cost_best == 1000 && width < 6) 
        ...
        [Wp_best, Wp, cost_best, cost, Gvis_best, Gvis] = recurse_cost(gs, ccg, gcg, GA, cost, cost_best, Wp, Wp_best, shape, [0 0], rows, cols, Gvis, Gvis, rows_init);
        Wp_s = Wp_best;
